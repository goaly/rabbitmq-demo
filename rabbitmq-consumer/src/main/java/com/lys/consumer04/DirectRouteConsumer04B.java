...
/**
 * DirectRouteConsumer04B  路由模式 - 消费者04B
 *
 * @author lys
 * @date 2022/5/14
 */
@Slf4j
public class DirectRouteConsumer04B {
     ...
     * 队列名称
     */
    private static final String QUEUE_NAME = "routing_direct_queue_b";
    ...
    private static final String ROUTING_KEY3 = "error";
